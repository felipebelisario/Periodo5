...
import mpointsgame.model.Face;
import mpointsgame.model.Suit;
...
public class Card {
    ...
    private boolean jaSelecionada = false;
    ...
    // Descobre o valor inteiro da carta
    public void discoverValue() {

        switch (this.getFace()){
            case ACE : this.set_NUMBER(1); break;
            case DEUCE : this.set_NUMBER(2); break;
            case THREE : this.set_NUMBER(3); break;
            case FOUR : this.set_NUMBER(4); break;
            case FIVE : this.set_NUMBER(5); break;
            case SIX : this.set_NUMBER(6); break;
            case SEVEN : this.set_NUMBER(7); break;
            case EIGHT : this.set_NUMBER(8); break;
            case NINE : this.set_NUMBER(9); break;
            case TEN : this.set_NUMBER(10); break;
            case JACK : this.set_NUMBER(11); break;
            case QUEEN : this.set_NUMBER(12); break;
            case KING : this.set_NUMBER(13); break;
            default : break;
        }
    }

    public boolean get_CardStatus() {
        return this.jaSelecionada;
    }

    public void set_CardStatus(boolean n) {
        this.jaSelecionada = n;
    }
}