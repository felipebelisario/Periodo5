...
public class HTMLEditor extends EditorFactory {
    ...
    public JToolBar createToolBar(ActionListener listener) {
        ...
        url.setText("Type your URL here");
        ...
        toolBar.addSeparator(new Dimension(400, toolBar.getHeight()));

        // Texto some do text field da URL quando se clica em cima
